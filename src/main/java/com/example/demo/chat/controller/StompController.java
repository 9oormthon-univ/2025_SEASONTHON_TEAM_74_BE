...
//    방법2.MessageMapping어노테이션만 활용.
    ...
    public void sendMessage(@DestinationVariable Long roomId, ChatReq.ChatMessageDtoReq req) throws JsonProcessingException {
        chatService.createChat(roomId, req, req.getChatRoomId());
